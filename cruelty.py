...
if v or ignore:
  cTarget.add_effect("Cruelty Mutagen", "-sdis wis -sdis int -sdis cha", desc = "When Ygv uses the Attack action, he can make an additional weapon attack as a bonus action.\n - Side effect: Ygv has disadvantage on Wisdom, Intelligence, and Charisma saving throws.")
...
-title "Ygv injects his Cruelty Mutagen!"
-f "When Ygv uses the Attack action, he can make an additional weapon attack as a bonus action.
 - Side effect: Ygv has disadvantage on Wisdom, Intelligence, and Charisma saving throws."
-color <color>
